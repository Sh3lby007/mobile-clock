...
<template>
  <div class="columns is-mobile is-multiline is-centered">
    ...
    <div class="column is-full">
      ...
      <button v-if="!timerRunning" @click="countDown" class="button is-success is-fullwidth is-responsive">
        Start
      </button>
      ...
      <button v-else @click="stopTimer" class="button is-warning is-fullwidth is-responsive">
        Stop
      </button>
      <br />
      <button @click="resetTimer" class="button is-danger is-fullwidth is-responsive">
        Reset
      </button>
